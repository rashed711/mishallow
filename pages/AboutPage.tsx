                    ...
                    <div className="grid lg:grid-cols-2 gap-12 md:gap-20 items-center">
                        ...
                        >
                            ...
                            <div className="space-y-6 text-slate-600 text-base md:text-lg leading-relaxed font-bold">
                                <p>مكتب مشعل بادغيش للمحاماة والاستشارات القانونية هو بيت خبرة قانوني متخصص، تأسس ليواكب القفزات النوعية في المنظومة العدلية السعودية ضمن رؤية المملكة 2030.</p>
