            ...
            <div className="prose prose-lg prose-slate max-w-none space-y-12">
              <div className="space-y-4">
                ...
                <p className="text-slate-600 font-medium text-lg leading-relaxed">
                  باستخدامك لموقع شركة مشعل بادغيش، فإنك تقر بالموافقة الكاملة على الشروط والأحكام. المحتوى المنشور هو لأغراض توعوية فقط ولا يغني عن الاستشارة المهنية المباشرة.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-slate-600 font-medium text-lg leading-relaxed">
                  جميع حقوق الملكية الفكرية للمحتوى والتصاميم والشعارات الموجودة في هذا الموقع مملوكة حصرياً لشركة مشعل بادغيش للمحاماة.
                </p>
              </div>
