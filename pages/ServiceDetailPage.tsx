    ...
    return (
        <div className="bg-slate-50 min-h-screen">
            <SEO
                ...
                image={service.image}
                type="service"
                url={`https://mishal-lawfirm.com/${service.slug}`}
                ...
                <div className="grid lg:grid-cols-3 gap-12">
                    ...
                    <div className="lg:col-span-2 space-y-12">
                        ...
                        >
                            ...
                            <p className="text-slate-400 mb-8 font-medium leading-relaxed">
                                نلتزم في شركة مشعل بادغيش بتطبيق أعلى معايير الامتثال العدلي من خلال تفعيل الأدوات النظامية والمنصات الرسمية التابعة لوزارة العدل والجهات القضائية في المملكة العربية السعودية.
                            </p>
                    ...
                    <div className="lg:col-span-1 space-y-8">
                        ...
                        <div className="bg-[#0F172A] rounded-[2.5rem] p-8 text-center sticky top-24">
                            ...
                            <p className="text-slate-400 mb-8 font-medium">تواصل معنا الآن للحصول على استشارة قانونية متخصصة وتقييم شامل لموقفك القضائي.</p>
                            <Link
                                to="/contact"
