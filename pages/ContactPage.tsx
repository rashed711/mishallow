    ...
    <div className="bg-[#0F172A]">
      ...
      <div className="pt-40 pb-20 relative overflow-hidden">
        <div className="absolute inset-0 opacity-10 pointer-events-none">
          <img src="/images/contact/contact-bg.webp" alt="تواصل مع شركة مشعل بادغيش للمحاماة" loading="eager" fetchPriority="high" decoding="async" className="w-full h-full object-cover" />
        </div>
      ...
      <section className="py-20 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="h-[400px] w-full bg-slate-800 rounded-[3rem] overflow-hidden relative border border-white/10 grayscale">
            <img src="/images/contact/map-bg.webp" alt="موقع شركة مشعل بادغيش للمحاماة في مكة المكرمة" loading="lazy" decoding="async" className="w-full h-full object-cover opacity-30" />
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center bg-white/10 backdrop-blur-xl p-8 rounded-3xl border border-white/20">
                ...
                <button className="text-white text-sm font-bold underline"><a href="https://maps.app.goo.gl/3pHtRrMiMs4LA931A" target="_blank" rel="noopener noreferrer">فتح الموقع في خرائط جوجل</a></button>
              </div>
            </div>
          </div>
        </div>
