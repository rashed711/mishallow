      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-10">
          {steps.map((step, index) => (
            <div key={index} className="relative p-10 bg-white rounded-[2.5rem] shadow-lg border border-slate-100 transition-all hover:-translate-y-2">
              <div className="absolute -top-6 -right-6 w-20 h-20 flex items-center justify-center bg-gradient-to-br from-[#B89544] to-[#D4AF37] rounded-3xl shadow-xl text-[#0F172A] text-3xl font-black">
                {step.num}
              </div>
