...
export const BriefcaseIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.07a2.25 2.25 0 01-2.25 2.25H5.92a2.25 2.25 0 01-2.15-2.223L3.102 7.152A3 3 0 016.03 4.5h11.94a3 3 0 012.928 2.652l.24 2.859M15.75 9.75v.75m-3-3.75v.75m-3-3.75v.75m-3 3.75v.75" />
  </svg>
);

export const ScaleIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v17.25m0 0c-1.472 0-2.882.265-4.185.75M12 20.25c1.472 0 2.882.265 4.185.75M18.75 4.97A48.416 48.416 0 0012 4.5c-2.291 0-4.545.16-6.75.47m13.5 0c1.01.143 2.01.317 3 .52m-3-.52l2.62 10.726c.122.499-.106 1.028-.589 1.202a5.988 5.988 0 01-2.036.243c-2.132 0-4.14-.834-5.657-2.343-1.517-1.509-2.343-3.525-2.343-5.657s.826-4.148 2.343-5.657c1.517-1.509 3.525-2.343 5.657-2.343zm-7.087 7.087c-1.517 1.509-2.343 3.525-2.343 5.657s.826 4.148 2.343 5.657c1.517 1.509 3.525-2.343 5.657-2.343s4.14-.834 5.657-2.343m-16.5 0a3.375 3.375 0 013.375-3.375h1.5a3.375 3.375 0 013.375 3.375v1.5a3.375 3.375 0 01-3.375 3.375h-1.5a3.375 3.375 0 01-3.375-3.375v-1.5z" />
  </svg>
);
...
export const UsersIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962c.51.056 1.02.082 1.5.082a9.094 9.094 0 013.741-.479m-4.5-1.5a5.25 5.25 0 00-4.5-1.5a5.25 5.25 0 00-4.5 1.5m15 0a5.25 5.25 0 00-4.5-1.5a5.25 5.25 0 00-4.5 1.5m-1.5-3a3 3 0 00-3-3a3 3 0 00-3 3M6.75 12a3 3 0 013-3a3 3 0 013 3m-3 3a3 3 0 00-3 3a3 3 0 003 3m6.75-6a3 3 0 013-3a3 3 0 013 3m-3 3a3 3 0 00-3 3a3 3 0 003 3" />
  </svg>
);
