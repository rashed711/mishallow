...
const features = [
  'فريق من المحامين المرخصين والممارسين أمام المحاكم التجارية',
  'تخصص عميق في نظام الشركات الجديد ونظام المعاملات المدنية',
  'خبراء في صياغة العقود المعقدة واتفاقيات المساهمين',
  'تمثيل قضائي رقمي متكامل عبر منصة ناجز ومنصة معين',
  'التزام بمعايير الحوكمة والشفافية المهنية السعودية',
];
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
          ...
          >
            <h2 className="text-3xl font-black text-gray-900 sm:text-5xl mb-6 text-center md:text-right">
              لماذا تختار شركة <br /><span className="text-[#B89544]">مشعل بادغيش</span>
            </h2>
