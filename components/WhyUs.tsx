            ...
            <ul className="space-y-5 reveal-stagger">
              {features.map((feature, index) => (
                <li key={index} className="flex items-center group">
                  <div className="flex-shrink-0 bg-[#B89544]/10 p-1.5 rounded-full group-hover:bg-[#B89544] transition-colors">
                    <CheckCircleIcon className="h-5 w-5 text-[#B89544] group-hover:text-white" />
                  </div>
                  <p className="mr-4 text-lg text-gray-700 font-bold">{feature}</p>
                </li>
              ))}
            </ul>
          </div>
          <div className="relative h-[500px] reveal" style={{ transitionDelay: '0.3s' }}>
