...
/**
 * =====================================================
 * شركة مشعل بادغيش - طبقة الأمان المشتركة
...
class Security
{
     ...
     * يقبل أرقام من أي دولة بصيغ مختلفة:
     * +966501234567 | 00966501234567 | 0501234567 | +1 555 123 4567
     */
    public static function validatePhone(string $phone): bool
    {
        // إزالة المسافات والشرطات والأقواس والنقاط
        $cleaned = preg_replace('/[\s\-\(\)\.]+/', '', $phone);
        // يقبل: + اختياري، ثم 7 إلى 15 رقمًا (معيار E.164 الدولي)
