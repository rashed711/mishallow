              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex bg-slate-50 p-1 rounded-xl border border-slate-100">
                  <button
                    ...
                    className={`px-5 py-1.5 rounded-lg text-[10px] font-black transition-all ${sortBy === 'date' ? 'bg-white text-[#B89544] shadow-sm' : 'text-slate-400'
                      }`}
                  >
                    التاريخ
                  </button>
                  <button
                    ...
                    className={`px-5 py-1.5 rounded-lg text-[10px] font-black transition-all ${sortBy === 'popularity' ? 'bg-white text-[#B89544] shadow-sm' : 'text-slate-400'
                      }`}
                  >
                    التفاعل
                  </button>
